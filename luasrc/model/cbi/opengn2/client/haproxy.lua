...
o.default = "opengn_logic"
o:value("tcp", "TCP")
o:value("opengn_logic", translate("URL Test") .. string.format("(opengn %s)", translate("Inner implement")))
o:depends("balancing_enable", true)

---- OpenGN Inner implement Probe URL
...
o:depends("health_check_type", "opengn_logic")
