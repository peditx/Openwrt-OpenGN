...
local require_dir = "luci.opengn2."

local ipt_bin = sys.exec("echo -n $(/usr/share/opengn2/iptables.sh get_ipt_bin)")
local ip6t_bin = sys.exec("echo -n $(/usr/share/opengn2/iptables.sh get_ip6t_bin)")
